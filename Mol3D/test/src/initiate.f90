...
SUBROUTINE inimol(basics, fluxes, grid, model, dust, gas, sources_in)
    ...
    max_expo_r1  = LOG(HUGE(1.0_r1))   ! largest exponent before overflow
    min_expo_r1  = LOG(TINY(1.0_r1))   ! smallest exponent before underflow
    
    max_expo_r2  = LOG(HUGE(1.0_r2))   ! largest exponent before overflow
    min_expo_r2  = LOG(TINY(1.0_r2))   ! smallest exponent before underflow
