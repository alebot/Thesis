...
CONTAINS
    ...
    ! ---
    SUBROUTINE interact(basics, model, grid, dust, rand_nr, fluxes, &
                        photon, deposit_energy)
        IMPLICIT NONE
        !----------------------------------------------------------------------!
        ...
        ELSE
            CALL interact_mc(basics, model, grid, dust, rand_nr, fluxes, photon)
        END IF
    ...
    ! ---
    SUBROUTINE interact_mc(basics, model, grid, dust, rand_nr, fluxes, photon)
        ...
        IF (photon%stokes(1) .gt. 1e-5_r2) THEN
