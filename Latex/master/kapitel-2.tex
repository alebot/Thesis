...
\begin{figure}
% Rather than specifying ﬁgure widths in raw terms, like centimetres, or docu-
...
% standard ﬁgure widths, \smallfigwidth, \mediumfigwidth, \largefigwidth
% and \hugefigwidth, which are deﬁned in terms of the text width and chosen
% to avoid overﬂows. Use them like this:
